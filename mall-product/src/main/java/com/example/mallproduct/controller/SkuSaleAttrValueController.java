...
public class SkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, SkuSaleAttrValueEntity skuSaleAttrValue){
        Page page = skuSaleAttrValueService.page(pageForm, Wrappers.query(skuSaleAttrValue));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("skuSaleAttrValue", skuSaleAttrValue);
        return R.success("查询成功",skuSaleAttrValue);
    }
