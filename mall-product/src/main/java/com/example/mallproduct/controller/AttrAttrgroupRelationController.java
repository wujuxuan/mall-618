...
public class AttrAttrgroupRelationController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, AttrAttrgroupRelationEntity attrAttrgroupRelation){
        Page page = attrAttrgroupRelationService.page(pageForm, Wrappers.query(attrAttrgroupRelation));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("attrAttrgroupRelation", attrAttrgroupRelation);
        return R.success("查询成功",attrAttrgroupRelation);
    }
